...
setup(
    ...
    data_files=[
        ...
        (f"share/{package_name}/launch", ["launch/dm_imu_iox.launch.py"]),
    ...
    entry_points={
        "console_scripts": [
            ...
            "dm_imu_iox_node = dm_imu.imu_node_with_iox2:main",
            "test_iox_imu_node = dm_imu.test_iox_imu:main",
        ],
    },
)
